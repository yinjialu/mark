...
[复制给 Codex 安装](docs/INSTALL.md#复制给-codex-自动安装) · [下载预览版](https://github.com/yinjialu/mark/releases/tag/v0.1.0-preview.9) · [使用说明](docs/USAGE.md) · [适配与开发](DEVELOPMENT.md)
...
```text
请阅读 https://github.com/yinjialu/mark/blob/v0.1.0-preview.9/docs/INSTALL.md，
