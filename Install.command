...
printf '%s\n' 'mark 0.1.2' '' '将从本机 ChatGPT 正式版生成独立副本，安装 mark 启动入口。标准插件可按 docs/INSTALL.md 另行安装。' '独立副本使用本地签名，并为该副本放宽库签名校验；正式版和系统安全设置不变。' '需要 macOS Apple Silicon、Command Line Tools。' ''
